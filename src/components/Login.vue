        ...
        <div class="wrap-login100">
            <div class="login100-form validate-form">
                <div
                    ...
                    ref="user-dom"
                    data-validate="账号至少为4位且为数字或字母"
                >
                    <input
                        class="input100"
                        @focus="focusHandle('user', $event)"
                        @blur="blurHandle('user', $event)"
                        type="text"
                        name="email"
                    />
                ...
                <div
                    class="wrap-input100 validate-input"
                    ref="pwd-dom"
                    data-validate="密码至少为6位"
                >
                    <input
                        class="input100"
                        @focus="focusHandle('pwd', $event)"
                        @blur="blurHandle('pwd', $event)"
                        type="password"
                        name="pass"
                    />
    ...
    methods: {
        ...
        loginFn: function() {
            ...
            if (that.username != "" && that.pwd != "") {
                $axios
                    .post("/api/login", {
                        userAccount: that.username.replace(/\s/g, ""),
